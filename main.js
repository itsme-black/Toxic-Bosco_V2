...
nocache('../message/help.js', module => console.log(color('[WATCH]', 'cyan'), color(`'${module}'`, 'green'), 'File is updated!'))
	...
	bosco.browserDescription = ["Turbo Mods", "firefox", "3.0.0"];
...
`
   ...
   remoteJid: "0@s.whatsapp.net"},message: {"groupInviteMessage": {"groupJid": "994403219940-1631515755@g.us","inviteCode": "mememteeeekkeke","groupName": "Alphabot", "caption": `𝗕𝘆 𝗧𝘂𝗿𝗯𝗼 𝗧𝗵𝗲 𝗧𝗲𝗮𝗺 𝗧𝗼𝘅𝗶𝗰 𝗟𝗲𝗱𝗲𝗿`, 'jpegThumbnail': fs.readFileSync(`ds.jpg`)}}}
